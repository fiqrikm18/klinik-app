...
namespace Apotik.models
{
    public class ModelDetailResep : IDataErrorInfo
    {
        ...
        public ModelDetailResep(string id, string no_resep, string kode_obat, string nama_obat, string dosis, string ket, string jumlah, int sub_total, int harga_obat, string tgl_buat)
        {
            this.id = id;
            this.no_resep = no_resep;
            this.kode_obat = kode_obat;
